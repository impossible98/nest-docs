...
Similarly, for [custom providers](./custom-providers), set the `scope` property in the long-hand form for a provider registration:
...
Similarly, for [custom providers](./custom-providers), set the `durable` property in the long-hand form for a provider registration:
