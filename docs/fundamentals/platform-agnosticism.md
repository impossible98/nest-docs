...
In addition, the [application context](../standalone-applications) feature helps to create any kind of Node.js application - including things like CRON jobs and CLI apps - on top of Nest.
